  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        'bgs3m' : "url('https://storage.googleapis.com/noxtestbucket/bgs3m.png')",
        'bgs3f' : "url('../public/bgs3f.png')",
        'bgs4' : "url('../public/bgs4.png')",
        'bgs5' : "url('../public/bgs5.png')",
        'bgs6' : "url('https://storage.googleapis.com/noxtestbucket/bgs6.png')",
        'bgs7' : "url('../public/bgs7.png')",
        'bgs9' : "url('../public/bgs9.png')",
        'bgs10' : "url('../public/bgs10.png')",
        'bgs7m' : "url('https://storage.googleapis.com/noxtestbucket/bgbgs7m.png')",
